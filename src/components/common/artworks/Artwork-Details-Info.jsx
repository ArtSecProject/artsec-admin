...
const ArtworkDetailsInfo = () => {
    ...
    return (
        <>
            <div className='block sm:block md:block lg:flex space-x-1 lg:space-x-4 px-2 lg:px-1'>
            <div className='w-full sm:w-full md:w-full lg:w-[38%] px-2 lg:px-1'>
                <h2 className='py-3 text-2xl font-bold'>Achal</h2>

                <div className='flex justify-between  items-center'>
                    <div>
                        <span className='text-[15px] font-normal text-[#606C84]'>Artist</span>
                        <p className='flex items-center text-[15px] font-normal text-[#000] pt-2'> <img src={UserImg} alt="ola" className='mr-2 w-7' /> Ola Samson</p>
                    </div>
                    <div>
                        <span className='text-[15px] font-normal text-[#606C84]'>Collection</span>
                        <p className='flex items-center text-[15px] font-semibold text-[#000] pt-2'> <img src={UserImg} alt="ola" className='mr-2 w-7' /> Abstract</p>
                    </div>
                </div>
                ...
                <div className='flex justify-between items-center py-4'>
                    ...
                    <p className='flex items-center space-x-2 app-color text-{15px} font-semibold'><icons.ArtSecCertified /> <Link to='#'>sec.gov/edgar</Link> </p>
                </div>

                <div>
                    <span className='text-[#606C84] text-[15px] font-normal'>Story behind this artwork</span>
